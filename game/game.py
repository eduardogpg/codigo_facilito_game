...
class Game:
    ...
    def __init__(self):
        ...
        self.sprite_dir = os.path.join(self.dir, 'sources/sprites')
    ...
    def generate_elements(self):
        ...
        self.player = Player(100, self.platform.rect.top - 200, self.sprite_dir)
        ...
        self.background = pygame.image.load(os.path.join(self.sprite_dir, 'background.png'))
    ...
    def generate_walls(self):
        ...
        if not self.exists_walls():
            ...
            for w in range(0, MAX_WALLS):
                ...
                pos_x = random.randrange(las_position + 200, las_position + 400)

                wall = Wall(pos_x, self.platform.rect.top, self.sprite_dir)
    ...
    def generate_coins(self):
        ...
        for w in range(0, MAX_COINS):
            ...
            pos_x = random.randrange(las_position + 180, las_position + 300)

            coin = Coin(pos_x, 100, self.sprite_dir)
    ...
    def draw_text(self):
        self.display_text(self.score_format(), 35, BLACK, WIDHT / 2,10)
        self.display_text(self.level_format(), 35, BLACK, 60, 10)

        if not self.playing:

            self.display_text('Presiona r para comenzar de nuevo', 30, RED, WIDHT / 2, 30)

            if self.win:
                self.display_text('Ganaste!!!', 80, BLACK, WIDHT / 2, HEIGHT / 2)
            else:
                self.display_text('Perdiste!!!', 80, BLACK, WIDHT / 2, HEIGHT / 2)
    ...
    def menu(self):
        ...
        self.display.fill(GREE_LIGTH)

        self.display_text('Presiona una tecla para comenzar', 36, BLACK, WIDHT / 2, 10)
